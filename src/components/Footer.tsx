...
const Footer: React.FC = () => {
  ...
  const handleNewsletterSignup = (e: React.FormEvent) => {
    ...
    if (email) {
      alert(
        `Thank you for subscribing, ${email}! You'll receive a 10% discount code shortly.`
      );
      setEmail("");
    }
  };
    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.newsletterBanner}>
        <div className={styles.newsletterContent}>
          ...
          <p>
            Subscribe to our newsletter for exclusive deals, gaming news, and
            more.
          </p>
          <form
      ...
      <div className={styles.footerGrid}>
        ...
        <div className={`${styles.footerCard} ${styles.aboutCard}`}>
          <h3 className={styles.cardTitle}>
            <FontAwesomeIcon icon={faStore} /> GameZone
          </h3>
          <p>
            Your ultimate destination for digital games. Discover, play, and
            connect with a global community of gamers.
          </p>
        ...
        <div className={styles.footerCard}>
          <h3 className={styles.cardTitle}>
            <FontAwesomeIcon icon={faTags} /> Quick Links
          </h3>
          <ul className={styles.linkList}>
            <li>
              <a href="#shop">Shop All Games</a>
            </li>
            <li>
        ...
        <div className={styles.footerCard}>
          <h3 className={styles.cardTitle}>
            <FontAwesomeIcon icon={faHeadset} /> Customer Service
          </h3>
          <ul className={styles.linkList}>
            <li>
            ...
            <li>
              <a href="#activation-guides">Activation Guides</a>
            </li>
          </ul>
        </div>
        ...
        <div className={styles.footerCard}>
          ...
          <ul className={styles.linkList}>
            ...
            <li>
              <a href="#giveaways">Giveaways & Contests</a>
            </li>
            <li>
